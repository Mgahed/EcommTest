                            ...
                            <div class="swiper product-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                ...
                                                class="img-fluid" src="https://placeimg.com/640/480/animals" alt="..."></a>
                                    </div>
                                    <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                                        href="https://placeimg.com/640/480/nature"
                                                                        data-gallery="gallery2"
                                                                        data-glightbox="Product item 2"><img
                                                class="img-fluid" src="https://placeimg.com/640/480/nature"
                                                alt="..."></a></div>
                                    <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                                        href="https://placeimg.com/640/480/tech"
                                                                        data-gallery="gallery2"
                                                                        data-glightbox="Product item 3"><img
                                                class="img-fluid" src="https://placeimg.com/640/480/tech" alt="..."></a>
                                    </div>
                                    <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                                        href="https://placeimg.com/640/480/nature"
                                                                        data-gallery="gallery2"
                ...
                <div class="col-lg-6">
                    ...
                    <form action="{{route('cart.add',$product->id)}}">
                        <div class="row align-items-stretch mb-4">
                            ...
                            <div class="col-sm-3 pl-sm-0">
                                <button class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-3"
                    ...
                    <ul class="list-unstyled small d-inline-block">
                        ...
                        <li class="px-3 py-2 mb-1 bg-white text-muted"><strong
                                class="text-uppercase text-dark">Price:</strong><span
                                class="ms-2 text-muted">${{$product->Price}}</span></li>
                        <li class="px-3 py-2 mb-1 bg-white text-muted"><strong
                                class="text-uppercase text-dark">Brand:</strong><a class="reset-anchor ms-2"
                                                                                   href="{{route('brands.details',$product->brand->id)}}">{{$product->brand->name}}</a>
                        </li>
                    </ul>
                </div>
            </div>
